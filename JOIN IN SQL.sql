...
FROM Employees3 e 
INNER JOIN    -- YOU CAN CHANGE THE JOIN NAME HERE LIKE :  RIGHT JOIN, LEFT JOIN, INNER JOIN
Departments d
ON e.department_id=d.department_id; --HERE WE USE ON TO FIND THE COMMON COLUMN TO MAE CONNECTION BOTH TABLLE
